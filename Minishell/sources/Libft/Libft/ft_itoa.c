...
static size_t	ft_str_length(int n);
static void		ft_n_to_str(char *str, int n, size_t length);
...
If n = 0, it writes 0 in str. If n = -2147483648 it writes the 8 at the end of
