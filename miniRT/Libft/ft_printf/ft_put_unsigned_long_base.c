...
/*   Updated: 2025/02/16 19:28:24 by daromoli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	calc_print_figure(int fd, size_t nbr, int length, char *base);
...
DESCRIPTION
This function prints the decimal unsigned long number nbr in a base system in
the terminal, while it counts the number of characters printed (count).
...
is returned and the execution stops.
*/
static int	calc_print_figure(int fd, size_t number, int length, char *base)
{
	int		count;
	int		tmp_count;
